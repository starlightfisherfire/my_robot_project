...
def main():
    ...
    parser.add_argument("--checkpoint-type", required=True, choices=["old_10epoch", "new_50epoch_nomass", "action_embed_50ep"])
    ...
    # Auto-detect use_action_embed from checkpoint
    ...
    # If checkpoint has _lf_proj (lastframe encoder), patch the encoder
    if "encoder._lf_proj.weight" in state_dict:
        ...
        print("  [PATCHED] encoder forward → lastframe (no GRU)")
