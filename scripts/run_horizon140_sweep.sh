...
# ============================================================
# Horizon 140 Single-Obstacle Sweep
# Speeds: 0.75, 1.0, 1.5
# Horizon: 140, execute_steps=10, max_mpc=100 → 1000 total steps
...
RUN_ROOT="runs/horizon140_sweep_$(date +%Y%m%d_%H%M%S)"
...
echo "============================================================"
echo "Horizon 140 Single-Obstacle Sweep"
