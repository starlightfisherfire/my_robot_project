...
def run_mujoco_oracle_mpc_closed_loop_mode(args: argparse.Namespace) -> None:
    ...
    print("num_templates:", summary["num_templates"])
    print("success_rate:", f"{summary['success_rate']:.3f}")
    print("success_rate_definition:", summary.get("success_rate_definition", "N/A"))
    print("primary_success_rate:", f"{summary.get('primary_success_rate', 0.0):.3f}")
    print("coarse_success_rate:", f"{summary.get('coarse_success_rate', 0.0):.3f}")
    print("precision_success_rate:", f"{summary.get('precision_success_rate', 0.0):.3f}")
    print("strict_completion_rate:", f"{summary.get('strict_completion_rate', 0.0):.3f}")
    print("legacy_pos_5cm_rate:", f"{summary.get('legacy_pos_5cm_rate', 0.0):.3f}")
    print("mean_initial_dist:", f"{summary['mean_initial_dist']:.4f}")
